package fuzs.strawstatues.common.client;
...
import fuzs.statuemenus.common.api.v1.client.gui.screens.StatueStyleScreen;
...
import fuzs.strawstatues.common.client.gui.screens.StrawStatuePositionScreen;
import fuzs.strawstatues.common.client.gui.screens.StrawStatueTexturesScreen;
import fuzs.strawstatues.common.client.model.geom.ModModelLayers;
import fuzs.strawstatues.common.client.renderer.entity.StrawStatueRenderer;
import fuzs.strawstatues.common.init.ModRegistry;
import fuzs.strawstatues.common.network.client.ServerboundPickItemFromEntityMessage;
...
public class StrawStatuesClient implements ClientModConstructor {
    ...
    private static void registerEventHandlers() {
        InteractionInputEvents.PICK.register((Minecraft minecraft, LocalPlayer player, HitResult hitResult) -> {
            if (hitResult instanceof EntityHitResult entityHitResult
                    && entityHitResult.getEntity() instanceof StrawStatue strawStatue) {
                MessageSender.broadcast(new ServerboundPickItemFromEntityMessage(strawStatue.getId(),
