package fuzs.strawstatues.common;
...
import fuzs.strawstatues.common.network.client.*;
...
public class StrawStatues implements ModConstructor {
    ...
    public void onRegisterPayloadTypes(PayloadTypesContext context) {
        ...
        context.playToServer(ServerboundPickItemFromEntityMessage.class,
                ServerboundPickItemFromEntityMessage.STREAM_CODEC);
    }
